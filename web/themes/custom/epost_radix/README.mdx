...
epost_radix theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of epost_radix theme and run the following commands:
`nvm use`
...
`drush en epost_radix -y`
`drush config-set system.theme default epost_radix -y`
